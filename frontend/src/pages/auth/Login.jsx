    ...
    >
      ...
      <div className="p-10">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
          {/* Email with inline arrow button */}
          <div>
            ...
            <div className="relative">
              <input
                ...
                {...register('email')}
                className="w-full bg-white/5 border border-white/10 rounded-2xl px-4 py-3.5 pr-14 text-white placeholder-white/20 focus:outline-none focus:border-primary/50 focus:bg-white/8 transition-all text-sm"
              />
              <button
                type="submit"
                disabled={isLoading}
                ...
                style={{
                  background: 'linear-gradient(135deg, #5de85d, #00c8c8)',
                }}
              >
                {isLoading
